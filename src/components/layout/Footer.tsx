        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-background/60 max-w-md mb-4">
              The campus marketplace where students connect, trade, and grow. 
              Offer your skills, sell your stuff, and find opportunities.
            </p>
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.linkedin.com/in/mwendahub" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-background/10 hover:bg-background/20 transition-colors" aria-label="LinkedIn">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5 text-[#0077B5]">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-background">Explore</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-background">Support</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/help" className="text-background/60 hover:text-primary transition-colors">Help Center</Link>
              </li>
              <li>
                <Link to="/safety" className="text-background/60 hover:text-primary transition-colors">Safety Tips</Link>
              </li>
              <li>
